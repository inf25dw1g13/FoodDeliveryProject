...
- Imagem desenhada no Miro: [Estrutura dos Containers](https://miro.com/app/board/uXjVJhjT7X0=/?share_link_id=289133236006)
...
- Imagem desenhada no Miro: [Arquitetura](https://miro.com/app/board/uXjVJi6sH_8=/?share_link_id=315844749630)  
...
- *localhost*:3001 – *React Admin Interface* (tanto em desenvolvimento como em produção)  
...
A *API* foi desenvolvida com *Node.js* e *LoopBack 4*, utilizando arquitetura baseada em *decorators* e *repositories*.
